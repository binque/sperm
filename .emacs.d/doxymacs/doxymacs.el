...
(defcustom doxymacs-external-xml-parser-executable
  "/home/dirlt/utils/doxymacs/bin/doxymacs_parser"
...
;;;我们这里只是使用JavaDoc这个模板..
;;;为了能够使用这个文件,我们需要设置doxymacs-doxygen-style为JavaDoc.
;;;在describe-variable里面可以设置.
...
(defcustom doxymacs-python-file-comment-template
  nil
  "A tempo template to insert for `doxymacs-insert-python-file-comment'.
If nil, then a default template based on the current style as indicated
by `doxymacs-doxygen-style' will be used.
...
(defun doxymacs-insert-python-file-comment ()
  "Inserts Python Doxygen documentation for the current file at current point."
  (interactive "*")
  (doxymacs-call-template "python-file-comment"))

(defconst doxymacs-JavaDoc-python-file-comment-template
  '("#!/usr/bin/env python" > n
    "#coding:utf-8" > n
    "#Copyright (C) dirlt" > n
    "" > n)
  "Default JavaDoc-style template for python file documentation.")

(define-key doxymacs-mode-map "\C-cdpi"
  'doxymacs-insert-python-file-comment)

;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;个人Html模板.
(defcustom doxymacs-html-file-comment-template
  nil
  "A tempo template to insert for `doxymacs-insert-html-file-comment'.
If nil, then a default template based on the current style as indicated
by `doxymacs-doxygen-style' will be used.
...
(defun doxymacs-insert-html-file-comment ()
  "Inserts Html Doxygen documentation for the current file at current point."
  (interactive "*")
  (doxymacs-call-template "html-file-comment"))

(defconst doxymacs-JavaDoc-html-file-comment-template
  '("<?xml version=\"1.0\" encoding=\"UTF-8\"?>" > n
    "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\"" > n
    "\"http://www.w3.org/TR/xhtml1/DTD/xhtml-strict.dtd\">" > n
    "<html xmlns=\"http://www.w3.org/1999/xhmtl\" lang=\"en\">" > n
    "<head>" > n
    "<title></title>" > n
    "</head>" > n
    "<body>" > n
    ...
    "</html>" > n
    "" > n)
  "Default JavaDoc-style template for html file documentation.")

(define-key doxymacs-mode-map "\C-cdhi"
  'doxymacs-insert-html-file-comment)
