...
** Computer System
   ...
   - [[file:systemtap.org][systemtap]] 可以用来深度地观察linux操作系统。
...
** Storage System
   ...
   - [[file:./dsgm.org][dsgm]] Document Synchronization based on Google Mail. https://github.com/dirtysalt/sperm/tree/master/code/py/dsgm *NOTE(dirlt):it really sucks. please ignore it*
